...
public class TcpTransport extends AbstractTcpTransport {
	...
	public TcpTransport(String remoteHost, int remotePort, String localIP, int localPort, 
			int connectTimeout, int responseTimeout, int pause, boolean keepConnection) {
		super(responseTimeout, pause, keepConnection, LoggerFactory.getLogger(TcpTransport.class));
